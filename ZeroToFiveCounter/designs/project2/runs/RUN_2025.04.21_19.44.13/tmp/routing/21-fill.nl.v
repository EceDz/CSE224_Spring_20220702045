module project2 (A,
 ...
 sky130_fd_sc_hd__buf_12 _234_ (.A(net9),
    .X(_165_));
 sky130_fd_sc_hd__clkbuf_4 _235_ (.A(net36),
    .X(_166_));
 sky130_fd_sc_hd__clkbuf_4 _236_ (.A(net1),
    .X(_167_));
 sky130_fd_sc_hd__and3b_1 _237_ (.A_N(net19),
    .B(net17),
    .C(net18),
    .X(_168_));
 sky130_fd_sc_hd__clkbuf_4 _238_ (.A(_168_),
    .X(_169_));
 sky130_fd_sc_hd__a221oi_2 _239_ (.A1(_166_),
    .A2(_167_),
    .B1(net19),
    .B2(net17),
    .C1(net18),
    .Y(_170_));
 sky130_fd_sc_hd__o22a_1 _240_ (.A1(_166_),
    .A2(_167_),
    .B1(_169_),
    .B2(_170_),
    .X(_171_));
 sky130_fd_sc_hd__and4b_1 _241_ (.A_N(net17),
    .B(net18),
    .C(_166_),
    .D(_167_),
    .X(_172_));
 sky130_fd_sc_hd__nand3b_4 _242_ (.A_N(net18),
    .B(net17),
    .C(net19),
    .Y(_173_));
 sky130_fd_sc_hd__nor2_1 _243_ (.A(_167_),
    .B(_173_),
    .Y(_174_));
 sky130_fd_sc_hd__or3_1 _244_ (.A(_171_),
    .B(_172_),
    .C(_174_),
    .X(_175_));
 sky130_fd_sc_hd__buf_1 _245_ (.A(_175_),
    .X(net20));
 sky130_fd_sc_hd__or3b_4 _246_ (.A(net19),
    .B(net18),
    .C_N(net17),
    .X(_176_));
 sky130_fd_sc_hd__buf_6 _247_ (.A(_176_),
    .X(_177_));
 sky130_fd_sc_hd__buf_8 _248_ (.A(net10),
    .X(_178_));
 sky130_fd_sc_hd__a21oi_1 _249_ (.A1(_166_),
    .A2(_177_),
    .B1(_178_),
    .Y(_179_));
 sky130_fd_sc_hd__and3_1 _250_ (.A(_177_),
    .B(_178_),
    .C(net36),
    .X(_180_));
 sky130_fd_sc_hd__clkbuf_4 _251_ (.A(net2),
    .X(_181_));
 sky130_fd_sc_hd__o21a_1 _252_ (.A1(_180_),
    .A2(_179_),
    .B1(_181_),
    .X(_182_));
 sky130_fd_sc_hd__nor3_4 _253_ (.A(_181_),
    .B(_179_),
    .C(_180_),
    .Y(_183_));
 sky130_fd_sc_hd__and2b_1 _254_ (.A_N(net1),
    .B(_166_),
    .X(_184_));
 sky130_fd_sc_hd__or3_1 _255_ (.A(_182_),
    .B(_183_),
    .C(_184_),
    .X(_185_));
 sky130_fd_sc_hd__nor2_2 _256_ (.A(net19),
    .B(net18),
    .Y(_186_));
 sky130_fd_sc_hd__o21ai_1 _257_ (.A1(_182_),
    .A2(_183_),
    .B1(_184_),
    .Y(_187_));
 sky130_fd_sc_hd__and2_2 _258_ (.A(_181_),
    .B(_178_),
    .X(_188_));
 sky130_fd_sc_hd__or3b_1 _259_ (.A(net17),
    .B(net18),
    .C_N(net19),
    .X(_189_));
 sky130_fd_sc_hd__buf_2 _260_ (.A(_189_),
    .X(_190_));
 sky130_fd_sc_hd__nor2_1 _261_ (.A(_188_),
    .B(_190_),
    .Y(_191_));
 sky130_fd_sc_hd__o22a_1 _262_ (.A1(_181_),
    .A2(_178_),
    .B1(_169_),
    .B2(_191_),
    .X(_192_));
 sky130_fd_sc_hd__nor3b_1 _263_ (.A(net19),
    .B(net17),
    .C_N(net18),
    .Y(_193_));
 sky130_fd_sc_hd__a2bb2o_1 _264_ (.A1_N(_181_),
    .A2_N(_173_),
    .B1(_188_),
    .B2(net28),
    .X(_194_));
 sky130_fd_sc_hd__and3_1 _265_ (.A(_166_),
    .B(_167_),
    .C(_188_),
    .X(_195_));
 sky130_fd_sc_hd__and3b_2 _266_ (.A_N(net17),
    .B(net18),
    .C(net19),
    .X(_196_));
 sky130_fd_sc_hd__a22o_1 _267_ (.A1(_166_),
    .A2(_181_),
    .B1(_178_),
    .B2(_167_),
    .X(_197_));
 sky130_fd_sc_hd__and3b_1 _268_ (.A_N(_195_),
    .B(_196_),
    .C(_197_),
    .X(_198_));
 sky130_fd_sc_hd__or3_1 _269_ (.A(_192_),
    .B(_194_),
    .C(_198_),
    .X(_199_));
 sky130_fd_sc_hd__a31o_1 _270_ (.A1(_185_),
    .A2(_186_),
    .A3(_187_),
    .B1(_199_),
    .X(net21));
 sky130_fd_sc_hd__and4_4 _271_ (.A(net10),
    .B(net2),
    .C(net9),
    .D(net3),
    .X(_200_));
 sky130_fd_sc_hd__clkbuf_8 _272_ (.A(net11),
    .X(_201_));
 sky130_fd_sc_hd__a22o_1 _273_ (.A1(net2),
    .A2(net10),
    .B1(net3),
    .B2(_165_),
    .X(_202_));
 sky130_fd_sc_hd__and4b_2 _274_ (.A_N(_200_),
    .B(_202_),
    .C(net1),
    .D(_201_),
    .X(_203_));
 sky130_fd_sc_hd__buf_12 _275_ (.A(net3),
    .X(_204_));
 sky130_fd_sc_hd__a21oi_1 _276_ (.A1(_166_),
    .A2(_204_),
    .B1(_188_),
    .Y(_205_));
 sky130_fd_sc_hd__o2bb2a_1 _277_ (.A1_N(_167_),
    .A2_N(_201_),
    .B1(_205_),
    .B2(net35),
    .X(_206_));
 sky130_fd_sc_hd__nor2_2 _278_ (.A(_203_),
    .B(_206_),
    .Y(_207_));
 sky130_fd_sc_hd__and2_2 _279_ (.A(_195_),
    .B(_207_),
    .X(_208_));
 sky130_fd_sc_hd__o21ai_1 _280_ (.A1(_195_),
    .A2(_207_),
    .B1(_196_),
    .Y(_209_));
 sky130_fd_sc_hd__o21a_2 _281_ (.A1(net36),
    .A2(_178_),
    .B1(_177_),
    .X(_210_));
 sky130_fd_sc_hd__xnor2_4 _282_ (.A(_201_),
    .B(_210_),
    .Y(_211_));
 sky130_fd_sc_hd__xor2_2 _283_ (.A(_204_),
    .B(_211_),
    .X(_212_));
 sky130_fd_sc_hd__o21bai_4 _284_ (.A1(_183_),
    .A2(_184_),
    .B1_N(_182_),
    .Y(_213_));
 sky130_fd_sc_hd__and2_4 _285_ (.A(_212_),
    .B(_213_),
    .X(_214_));
 sky130_fd_sc_hd__o21ai_1 _286_ (.A1(_212_),
    ...
    .B1(_186_),
    .Y(_215_));
 sky130_fd_sc_hd__and2_2 _287_ (.A(net3),
    .B(net11),
    .X(_216_));
 sky130_fd_sc_hd__nor2_1 _288_ (.A(_190_),
    .B(_216_),
    .Y(_217_));
 sky130_fd_sc_hd__o22ai_4 _289_ (.A1(_204_),
    .A2(_201_),
    .B1(_169_),
    .B2(_217_),
    .Y(_218_));
 sky130_fd_sc_hd__o2bb2a_1 _290_ (.A1_N(_193_),
    .A2_N(_216_),
    .B1(_204_),
    .B2(_173_),
    .X(_219_));
 sky130_fd_sc_hd__o211a_1 _291_ (.A1(_214_),
    .A2(_215_),
    .B1(_218_),
    .C1(_219_),
    .X(_220_));
 sky130_fd_sc_hd__o21ai_1 _292_ (.A1(_208_),
    .A2(_209_),
    .B1(_220_),
    .Y(net22));
 sky130_fd_sc_hd__clkbuf_4 _293_ (.A(net12),
    .X(_221_));
 sky130_fd_sc_hd__nand2_2 _294_ (.A(net2),
    .B(_201_),
    .Y(_222_));
 sky130_fd_sc_hd__and4_4 _295_ (.A(net10),
    .B(net9),
    .C(net3),
    .D(net4),
    .X(_223_));
 sky130_fd_sc_hd__buf_6 _296_ (.A(net4),
    .X(_224_));
 sky130_fd_sc_hd__a22oi_4 _297_ (.A1(_204_),
    .A2(_178_),
    .B1(_224_),
    .B2(_165_),
    .Y(_225_));
 sky130_fd_sc_hd__nor2_2 _298_ (.A(_223_),
    .B(_225_),
    .Y(_226_));
 sky130_fd_sc_hd__xnor2_2 _299_ (.A(_226_),
    .B(_222_),
    .Y(_227_));
 sky130_fd_sc_hd__nor2_4 _300_ (.A(net35),
    .B(_203_),
    .Y(_228_));
 sky130_fd_sc_hd__xnor2_2 _301_ (.A(_228_),
    .B(_227_),
    .Y(_229_));
 sky130_fd_sc_hd__and3_4 _302_ (.A(_229_),
    .B(_221_),
    .C(_167_),
    .X(_230_));
 sky130_fd_sc_hd__a21oi_1 _303_ (.A1(_167_),
    .A2(_221_),
    .B1(net38),
    .Y(_231_));
 sky130_fd_sc_hd__nor2_2 _304_ (.A(_231_),
    .B(_230_),
    .Y(_232_));
 sky130_fd_sc_hd__or2_1 _305_ (.A(_208_),
    .B(_232_),
    .X(_233_));
 sky130_fd_sc_hd__nand2_2 _306_ (.A(_232_),
    .B(_208_),
    .Y(_000_));
 sky130_fd_sc_hd__and2_1 _307_ (.A(_204_),
    .B(_211_),
    .X(_001_));
 sky130_fd_sc_hd__o31a_1 _308_ (.A1(net36),
    .A2(_178_),
    .A3(_201_),
    .B1(_177_),
    .X(_002_));
 sky130_fd_sc_hd__nor2_1 _309_ (.A(_221_),
    .B(_002_),
    .Y(_003_));
 sky130_fd_sc_hd__and2_1 _310_ (.A(_221_),
    .B(_002_),
    .X(_004_));
 sky130_fd_sc_hd__o21a_2 _311_ (.A1(_003_),
    .A2(_004_),
    .B1(_224_),
    .X(_005_));
 sky130_fd_sc_hd__nor3_1 _312_ (.A(_224_),
    .B(_003_),
    .C(_004_),
    .Y(_006_));
 sky130_fd_sc_hd__nor2_2 _313_ (.A(_005_),
    .B(_006_),
    .Y(_007_));
 sky130_fd_sc_hd__o21a_2 _314_ (.A1(_001_),
    .A2(_214_),
    .B1(_007_),
    .X(_008_));
 sky130_fd_sc_hd__o31ai_1 _315_ (.A1(_001_),
    .A2(_214_),
    .A3(_007_),
    .B1(_186_),
    .Y(_009_));
 sky130_fd_sc_hd__a21oi_1 _316_ (.A1(_224_),
    .A2(_221_),
    .B1(_190_),
    .Y(_010_));
 sky130_fd_sc_hd__o22a_1 _317_ (.A1(_224_),
    .A2(_221_),
    .B1(_169_),
    .B2(_010_),
    .X(_011_));
 sky130_fd_sc_hd__a31o_1 _318_ (.A1(_224_),
    .A2(_221_),
    .A3(net28),
    .B1(_011_),
    .X(_012_));
 sky130_fd_sc_hd__o21ba_1 _319_ (.A1(_224_),
    .A2(_173_),
    .B1_N(_012_),
    .X(_013_));
 sky130_fd_sc_hd__o21ai_1 _320_ (.A1(_008_),
    .A2(_009_),
    .B1(_013_),
    .Y(_014_));
 sky130_fd_sc_hd__a31o_1 _321_ (.A1(_196_),
    .A2(_233_),
    .A3(_000_),
    .B1(_014_),
    .X(net23));
 sky130_fd_sc_hd__buf_12 _322_ (.A(net5),
    .X(_015_));
 sky130_fd_sc_hd__buf_4 _323_ (.A(net13),
    .X(_016_));
 sky130_fd_sc_hd__o21a_1 _324_ (.A1(_002_),
    .A2(_221_),
    .B1(_177_),
    .X(_017_));
 sky130_fd_sc_hd__xnor2_2 _325_ (.A(_016_),
    .B(net29),
    .Y(_018_));
 sky130_fd_sc_hd__nand2_2 _326_ (.A(net39),
    .B(_018_),
    .Y(_019_));
 sky130_fd_sc_hd__or2_1 _327_ (.A(_015_),
    .B(_018_),
    .X(_020_));
 sky130_fd_sc_hd__and2_4 _328_ (.A(_019_),
    .B(_020_),
    .X(_021_));
 sky130_fd_sc_hd__or3_1 _329_ (.A(_005_),
    .B(_008_),
    .C(_021_),
    .X(_022_));
 sky130_fd_sc_hd__o21ai_4 _330_ (.A1(_008_),
    .A2(_005_),
    .B1(_021_),
    .Y(_023_));
 sky130_fd_sc_hd__and2b_1 _331_ (.A_N(_228_),
    .B(_227_),
    .X(_024_));
 sky130_fd_sc_hd__and4_4 _332_ (.A(net1),
    .B(_181_),
    .C(net12),
    .D(_016_),
    .X(_025_));
 sky130_fd_sc_hd__a22oi_1 _333_ (.A1(_181_),
    .A2(_221_),
    .B1(_016_),
    .B2(net1),
    .Y(_026_));
 sky130_fd_sc_hd__or2_4 _334_ (.A(_025_),
    .B(_026_),
    .X(_027_));
 sky130_fd_sc_hd__nand4_4 _335_ (.A(_015_),
    .B(net10),
    .C(net4),
    .D(_165_),
    .Y(_028_));
 sky130_fd_sc_hd__a22o_4 _336_ (.A1(net10),
    .A2(net4),
    .B1(_165_),
    .B2(net5),
    .X(_029_));
 sky130_fd_sc_hd__a21o_1 _337_ (.A1(_028_),
    .A2(_029_),
    .B1(_216_),
    .X(_030_));
 sky130_fd_sc_hd__nand3_1 _338_ (.A(_216_),
    .B(_028_),
    .C(_029_),
    .Y(_031_));
 sky130_fd_sc_hd__o21bai_4 _339_ (.A1(_225_),
    .A2(_222_),
    .B1_N(_223_),
    .Y(_032_));
 sky130_fd_sc_hd__and3_1 _340_ (.A(_031_),
    .B(_030_),
    .C(_032_),
    .X(_033_));
 sky130_fd_sc_hd__a21oi_2 _341_ (.A1(_030_),
    .A2(_031_),
    .B1(_032_),
    .Y(_034_));
 sky130_fd_sc_hd__nor2_2 _342_ (.A(_033_),
    .B(_034_),
    .Y(_035_));
 sky130_fd_sc_hd__xnor2_2 _343_ (.A(_027_),
    .B(_035_),
    .Y(_036_));
 sky130_fd_sc_hd__o21a_4 _344_ (.A1(_024_),
    .A2(_230_),
    .B1(_036_),
    .X(_037_));
 sky130_fd_sc_hd__nor3_2 _345_ (.A(_024_),
    .B(_230_),
    .C(_036_),
    .Y(_038_));
 sky130_fd_sc_hd__nor2_2 _346_ (.A(_037_),
    .B(_038_),
    .Y(_039_));
 sky130_fd_sc_hd__xnor2_1 _347_ (.A(_000_),
    .B(_039_),
    .Y(_040_));
 sky130_fd_sc_hd__nor2_1 _348_ (.A(net39),
    .B(_173_),
    .Y(_041_));
 sky130_fd_sc_hd__a31o_1 _349_ (.A1(net39),
    .A2(_016_),
    .A3(net28),
    .B1(_041_),
    .X(_042_));
 sky130_fd_sc_hd__a21oi_1 _350_ (.A1(net39),
    .A2(_016_),
    .B1(_190_),
    .Y(_043_));
 sky130_fd_sc_hd__o22a_1 _351_ (.A1(net39),
    .A2(_016_),
    .B1(_169_),
    .B2(_043_),
    .X(_044_));
 sky130_fd_sc_hd__a211o_1 _352_ (.A1(_196_),
    .A2(_040_),
    .B1(_042_),
    .C1(_044_),
    .X(_045_));
 sky130_fd_sc_hd__a31o_1 _353_ (.A1(_186_),
    .A2(_022_),
    .A3(_023_),
    .B1(_045_),
    .X(net24));
 sky130_fd_sc_hd__buf_12 _354_ (.A(net6),
    .X(_046_));
 sky130_fd_sc_hd__nand2_2 _355_ (.A(net1),
    .B(net14),
    .Y(_047_));
 sky130_fd_sc_hd__and4_1 _356_ (.A(net2),
    .B(net3),
    .C(net12),
    .D(net13),
    .X(_048_));
 sky130_fd_sc_hd__a22oi_2 _357_ (.A1(_204_),
    .A2(net12),
    .B1(_016_),
    .B2(net2),
    .Y(_049_));
 sky130_fd_sc_hd__nor2_4 _358_ (.A(_048_),
    .B(_049_),
    .Y(_050_));
 sky130_fd_sc_hd__xnor2_4 _359_ (.A(_047_),
    .B(_050_),
    .Y(_051_));
 sky130_fd_sc_hd__nand4_4 _360_ (.A(net36),
    .B(net10),
    .C(net5),
    .D(_046_),
    .Y(_052_));
 sky130_fd_sc_hd__a22o_4 _361_ (.A1(net10),
    .A2(net5),
    .B1(net6),
    .B2(net9),
    .X(_053_));
 sky130_fd_sc_hd__and2_1 _362_ (.A(net11),
    .B(net4),
    .X(_054_));
 sky130_fd_sc_hd__a21o_4 _363_ (.A1(_052_),
    .A2(_053_),
    .B1(_054_),
    .X(_055_));
 sky130_fd_sc_hd__nand3_2 _364_ (.A(_054_),
    .B(_052_),
    .C(_053_),
    .Y(_056_));
 sky130_fd_sc_hd__a21bo_4 _365_ (.A1(_029_),
    .A2(_216_),
    .B1_N(_028_),
    .X(_057_));
 sky130_fd_sc_hd__nand3_4 _366_ (.A(_055_),
    .B(_056_),
    .C(_057_),
    .Y(_058_));
 sky130_fd_sc_hd__a21o_4 _367_ (.A1(_056_),
    .A2(_055_),
    .B1(_057_),
    .X(_059_));
 sky130_fd_sc_hd__nand3_2 _368_ (.A(_051_),
    .B(_058_),
    .C(_059_),
    .Y(_060_));
 sky130_fd_sc_hd__a21o_1 _369_ (.A1(_059_),
    .A2(_058_),
    .B1(_051_),
    .X(_061_));
 sky130_fd_sc_hd__o21bai_4 _370_ (.A1(_027_),
    .A2(_034_),
    .B1_N(_033_),
    .Y(_062_));
 sky130_fd_sc_hd__nand3_4 _371_ (.A(net30),
    .B(_060_),
    .C(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__a21o_1 _372_ (.A1(_061_),
    .A2(_060_),
    .B1(_062_),
    .X(_064_));
 sky130_fd_sc_hd__a21o_4 _373_ (.A1(_064_),
    .A2(_063_),
    .B1(_025_),
    .X(_065_));
 sky130_fd_sc_hd__nand3_4 _374_ (.A(_063_),
    .B(_025_),
    .C(_064_),
    .Y(_066_));
 sky130_fd_sc_hd__nand3_4 _375_ (.A(_037_),
    .B(_065_),
    .C(net33),
    .Y(_067_));
 sky130_fd_sc_hd__a21o_1 _376_ (.A1(_066_),
    .A2(_065_),
    .B1(_037_),
    .X(_068_));
 sky130_fd_sc_hd__a32oi_1 _377_ (.A1(_208_),
    .A2(_232_),
    .A3(_039_),
    .B1(_067_),
    .B2(net34),
    .Y(_069_));
 sky130_fd_sc_hd__and4b_2 _378_ (.A_N(_000_),
    .B(_068_),
    .C(_067_),
    .D(_039_),
    .X(_070_));
 sky130_fd_sc_hd__or3b_2 _379_ (.A(_069_),
    .B(_070_),
    .C_N(_196_),
    .X(_071_));
 sky130_fd_sc_hd__nand2_1 _380_ (.A(_019_),
    .B(_023_),
    .Y(_072_));
 sky130_fd_sc_hd__o21a_1 _381_ (.A1(_017_),
    .A2(_016_),
    .B1(_177_),
    .X(_073_));
 sky130_fd_sc_hd__xnor2_2 _382_ (.A(_073_),
    .B(net14),
    .Y(_074_));
 sky130_fd_sc_hd__nand2_2 _383_ (.A(net37),
    .B(_074_),
    .Y(_075_));
 sky130_fd_sc_hd__or2_4 _384_ (.A(_074_),
    .B(_046_),
    .X(_076_));
 sky130_fd_sc_hd__and2_4 _385_ (.A(_075_),
    .B(_076_),
    .X(_077_));
 sky130_fd_sc_hd__xor2_1 _386_ (.A(_072_),
    .B(_077_),
    .X(_078_));
 sky130_fd_sc_hd__a21oi_2 _387_ (.A1(net37),
    .A2(net14),
    .B1(_190_),
    .Y(_079_));
 sky130_fd_sc_hd__o22a_1 _388_ (.A1(net37),
    .A2(net14),
    .B1(_169_),
    .B2(_079_),
    .X(_080_));
 sky130_fd_sc_hd__a31o_1 _389_ (.A1(net37),
    .A2(net14),
    .A3(net28),
    .B1(_080_),
    .X(_081_));
 sky130_fd_sc_hd__a21oi_1 _390_ (.A1(_186_),
    .A2(_078_),
    .B1(_081_),
    .Y(_082_));
 sky130_fd_sc_hd__o211ai_2 _391_ (.A1(net37),
    .A2(_173_),
    .B1(_071_),
    .C1(_082_),
    .Y(net25));
 sky130_fd_sc_hd__a21bo_4 _392_ (.A1(_023_),
    .A2(_019_),
    .B1_N(_077_),
    .X(_083_));
 sky130_fd_sc_hd__or2_4 _393_ (.A(net14),
    .B(_073_),
    .X(_084_));
 sky130_fd_sc_hd__nand2_4 _394_ (.A(_177_),
    .B(_084_),
    .Y(_085_));
 sky130_fd_sc_hd__xor2_4 _395_ (.A(_085_),
    .B(net15),
    .X(_086_));
 sky130_fd_sc_hd__xnor2_2 _396_ (.A(net7),
    .B(_086_),
    .Y(_087_));
 sky130_fd_sc_hd__a21oi_4 _397_ (.A1(_083_),
    .A2(_075_),
    .B1(_087_),
    .Y(_088_));
 sky130_fd_sc_hd__a311o_1 _398_ (.A1(_075_),
    .A2(_083_),
    .A3(_087_),
    .B1(net18),
    .C1(net19),
    .X(_089_));
 sky130_fd_sc_hd__a31o_2 _399_ (.A1(net1),
    .A2(net14),
    .A3(_050_),
    .B1(_048_),
    .X(_090_));
 sky130_fd_sc_hd__nand2_1 _400_ (.A(net1),
    .B(net15),
    .Y(_091_));
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(_090_),
    .B(_091_),
    .Y(_092_));
 sky130_fd_sc_hd__nand4_4 _402_ (.A(_046_),
    .B(net10),
    .C(_165_),
    .D(net7),
    .Y(_093_));
 sky130_fd_sc_hd__a22o_2 _403_ (.A1(net10),
    .A2(net6),
    .B1(net7),
    .B2(net9),
    .X(_094_));
 sky130_fd_sc_hd__a22o_4 _404_ (.A1(_201_),
    .A2(_015_),
    .B1(_093_),
    .B2(_094_),
    .X(_095_));
 sky130_fd_sc_hd__nand4_4 _405_ (.A(_201_),
    .B(_015_),
    .C(_093_),
    .D(_094_),
    .Y(_096_));
 sky130_fd_sc_hd__a21bo_4 _406_ (.A1(_054_),
    .A2(_053_),
    .B1_N(_052_),
    .X(_097_));
 sky130_fd_sc_hd__nand3_2 _407_ (.A(_095_),
    .B(_096_),
    .C(_097_),
    .Y(_098_));
 sky130_fd_sc_hd__a21o_1 _408_ (.A1(_095_),
    .A2(_096_),
    .B1(_097_),
    .X(_099_));
 sky130_fd_sc_hd__nand2_1 _409_ (.A(_181_),
    .B(net14),
    .Y(_100_));
 sky130_fd_sc_hd__a22oi_1 _410_ (.A1(_224_),
    .A2(net12),
    .B1(net13),
    .B2(_204_),
    .Y(_101_));
 sky130_fd_sc_hd__and4_1 _411_ (.A(_204_),
    .B(net4),
    .C(net12),
    .D(net13),
    .X(_102_));
 sky130_fd_sc_hd__nor2_2 _412_ (.A(_101_),
    .B(_102_),
    .Y(_103_));
 sky130_fd_sc_hd__xnor2_2 _413_ (.A(_100_),
    .B(_103_),
    .Y(_104_));
 sky130_fd_sc_hd__a21o_1 _414_ (.A1(_098_),
    .A2(_099_),
    .B1(_104_),
    .X(_105_));
 sky130_fd_sc_hd__nand3_2 _415_ (.A(_104_),
    .B(_098_),
    .C(_099_),
    .Y(_106_));
 sky130_fd_sc_hd__a21bo_4 _416_ (.A1(_051_),
    .A2(_059_),
    .B1_N(_058_),
    .X(_107_));
 sky130_fd_sc_hd__nand3_2 _417_ (.A(_105_),
    .B(_106_),
    .C(_107_),
    .Y(_108_));
 sky130_fd_sc_hd__a21o_1 _418_ (.A1(_105_),
    .A2(_106_),
    .B1(_107_),
    .X(_109_));
 sky130_fd_sc_hd__and3_4 _419_ (.A(_109_),
    .B(_108_),
    .C(_092_),
    .X(_110_));
 sky130_fd_sc_hd__a21oi_2 _420_ (.A1(_108_),
    .A2(_109_),
    .B1(_092_),
    .Y(_111_));
 sky130_fd_sc_hd__a211o_4 _421_ (.A1(_066_),
    .A2(_063_),
    .B1(_111_),
    .C1(_110_),
    .X(_112_));
 sky130_fd_sc_hd__o211ai_2 _422_ (.A1(_110_),
    .A2(_111_),
    .B1(_063_),
    .C1(_066_),
    .Y(_113_));
 sky130_fd_sc_hd__and3b_1 _423_ (.A_N(_067_),
    .B(_112_),
    .C(_113_),
    .X(_114_));
 sky130_fd_sc_hd__a21bo_4 _424_ (.A1(_113_),
    .A2(_112_),
    .B1_N(_067_),
    .X(_115_));
 sky130_fd_sc_hd__and2b_1 _425_ (.A_N(_114_),
    .B(_115_),
    .X(_116_));
 sky130_fd_sc_hd__nand2_1 _426_ (.A(net31),
    .B(_116_),
    .Y(_117_));
 sky130_fd_sc_hd__o21a_1 _427_ (.A1(net31),
    .A2(_116_),
    .B1(_196_),
    .X(_118_));
 sky130_fd_sc_hd__nor2_1 _428_ (.A(net7),
    .B(_173_),
    .Y(_119_));
 sky130_fd_sc_hd__a21oi_1 _429_ (.A1(net7),
    ...
    .B1(_190_),
    .Y(_120_));
 sky130_fd_sc_hd__o22a_1 _430_ (.A1(net7),
    .A2(net15),
    .B1(_169_),
    .B2(_120_),
    .X(_121_));
 sky130_fd_sc_hd__a311o_1 _431_ (.A1(net7),
    .A2(net15),
    .A3(net28),
    .B1(_119_),
    .C1(_121_),
    .X(_122_));
 sky130_fd_sc_hd__a21oi_2 _432_ (.A1(_118_),
    .A2(_117_),
    .B1(_122_),
    .Y(_123_));
 sky130_fd_sc_hd__o21ai_2 _433_ (.A1(_088_),
    .A2(_089_),
    .B1(_123_),
    .Y(net26));
 sky130_fd_sc_hd__a21o_1 _434_ (.A1(net7),
    .A2(_086_),
    .B1(_088_),
    .X(_124_));
 sky130_fd_sc_hd__nand2_1 _435_ (.A(net8),
    .B(net16),
    .Y(_125_));
 sky130_fd_sc_hd__or2_2 _436_ (.A(net8),
    .B(net16),
    .X(_126_));
 sky130_fd_sc_hd__nand2_2 _437_ (.A(_125_),
    .B(_126_),
    .Y(_127_));
 sky130_fd_sc_hd__o21a_1 _438_ (.A1(net15),
    .A2(_084_),
    .B1(_177_),
    .X(_128_));
 sky130_fd_sc_hd__xnor2_2 _439_ (.A(_127_),
    .B(_128_),
    .Y(_129_));
 sky130_fd_sc_hd__xnor2_2 _440_ (.A(_124_),
    .B(_129_),
    .Y(_130_));
 sky130_fd_sc_hd__a21o_1 _441_ (.A1(_070_),
    .A2(_115_),
    .B1(_114_),
    .X(_131_));
 sky130_fd_sc_hd__and3_1 _442_ (.A(_167_),
    .B(net15),
    .C(_090_),
    .X(_132_));
 sky130_fd_sc_hd__xnor2_2 _443_ (.A(_132_),
    .B(_112_),
    .Y(_133_));
 sky130_fd_sc_hd__inv_2 _444_ (.A(_108_),
    .Y(_134_));
 sky130_fd_sc_hd__nor2_1 _445_ (.A(_134_),
    .B(_110_),
    .Y(_135_));
 sky130_fd_sc_hd__nand2_1 _446_ (.A(_098_),
    .B(_106_),
    .Y(_136_));
 sky130_fd_sc_hd__a22o_1 _447_ (.A1(_224_),
    .A2(_016_),
    .B1(_046_),
    .B2(_201_),
    .X(_137_));
 sky130_fd_sc_hd__nand4_2 _448_ (.A(_201_),
    .B(_224_),
    .C(_016_),
    .D(_046_),
    .Y(_138_));
 sky130_fd_sc_hd__a22o_1 _449_ (.A1(_178_),
    .A2(net7),
    .B1(net8),
    .B2(_166_),
    .X(_139_));
 sky130_fd_sc_hd__nand4_2 _450_ (.A(_166_),
    .B(_178_),
    .C(net7),
    .D(net8),
    .Y(_140_));
 sky130_fd_sc_hd__and4_1 _451_ (.A(_137_),
    .B(_138_),
    .C(_139_),
    .D(_140_),
    .X(_141_));
 sky130_fd_sc_hd__a22o_1 _452_ (.A1(_137_),
    .A2(_138_),
    .B1(_139_),
    .B2(_140_),
    .X(_142_));
 sky130_fd_sc_hd__or2b_1 _453_ (.A(_141_),
    .B_N(_142_),
    .X(_143_));
 sky130_fd_sc_hd__nand2_1 _454_ (.A(net32),
    .B(_096_),
    .Y(_144_));
 sky130_fd_sc_hd__a31o_1 _455_ (.A1(_181_),
    .A2(net14),
    .A3(_103_),
    .B1(_102_),
    .X(_145_));
 sky130_fd_sc_hd__xor2_1 _456_ (.A(_144_),
    .B(_145_),
    .X(_146_));
 sky130_fd_sc_hd__nand2_1 _457_ (.A(_221_),
    .B(_015_),
    .Y(_147_));
 sky130_fd_sc_hd__nand2_1 _458_ (.A(_204_),
    .B(net14),
    .Y(_148_));
 sky130_fd_sc_hd__nand2_1 _459_ (.A(net1),
    .B(net16),
    .Y(_149_));
 sky130_fd_sc_hd__nand2_1 _460_ (.A(net2),
    .B(net15),
    .Y(_150_));
 sky130_fd_sc_hd__xor2_1 _461_ (.A(_149_),
    .B(_150_),
    .X(_151_));
 sky130_fd_sc_hd__xnor2_2 _462_ (.A(_148_),
    .B(_151_),
    .Y(_152_));
 sky130_fd_sc_hd__xnor2_2 _463_ (.A(_147_),
    .B(_152_),
    .Y(_153_));
 sky130_fd_sc_hd__xnor2_1 _464_ (.A(_146_),
    .B(_153_),
    .Y(_154_));
 sky130_fd_sc_hd__xnor2_2 _465_ (.A(_143_),
    .B(_154_),
    .Y(_155_));
 sky130_fd_sc_hd__xor2_2 _466_ (.A(_136_),
    .B(_155_),
    .X(_156_));
 sky130_fd_sc_hd__xnor2_1 _467_ (.A(_135_),
    .B(_156_),
    .Y(_157_));
 sky130_fd_sc_hd__xnor2_2 _468_ (.A(_133_),
    .B(_157_),
    .Y(_158_));
 sky130_fd_sc_hd__nand2_2 _469_ (.A(net40),
    .B(_158_),
    .Y(_159_));
 sky130_fd_sc_hd__o21a_1 _470_ (.A1(_158_),
    .A2(_131_),
    .B1(_196_),
    .X(_160_));
 sky130_fd_sc_hd__nor2_1 _471_ (.A(net8),
    .B(_173_),
    .Y(_161_));
 sky130_fd_sc_hd__a2bb2o_1 _472_ (.A1_N(_190_),
    .A2_N(_127_),
    .B1(_126_),
    .B2(_169_),
    .X(_162_));
 sky130_fd_sc_hd__a311o_1 _473_ (.A1(net8),
    .A2(net16),
    .A3(net28),
    .B1(_161_),
    .C1(_162_),
    .X(_163_));
 sky130_fd_sc_hd__a21o_1 _474_ (.A1(_159_),
    .A2(_160_),
    .B1(_163_),
    .X(_164_));
 sky130_fd_sc_hd__a21o_1 _475_ (.A1(_186_),
    .A2(_130_),
    .B1(_164_),
    .X(net27));
 ...
 sky130_fd_sc_hd__buf_4 input6 (.A(A[5]),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_8 input7 (.A(A[6]),
    .X(net7));
 ...
 sky130_fd_sc_hd__buf_6 output27 (.A(net27),
    .X(out[7]));
 sky130_fd_sc_hd__buf_2 max_cap28 (.A(_193_),
    .X(net28));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer1 (.A(_017_),
    .X(net29));
 sky130_fd_sc_hd__clkbuf_2 rebuffer2 (.A(_061_),
    .X(net30));
 sky130_fd_sc_hd__buf_2 rebuffer3 (.A(_070_),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_093_),
    .X(net32));
 sky130_fd_sc_hd__buf_6 rebuffer5 (.A(_066_),
    .X(net33));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer6 (.A(_068_),
    .X(net34));
 sky130_fd_sc_hd__buf_2 rebuffer7 (.A(_200_),
    .X(net35));
 sky130_fd_sc_hd__clkbuf_16 clone8 (.A(net9),
    .X(net36));
 sky130_fd_sc_hd__clkbuf_16 clone9 (.A(net6),
    .X(net37));
 sky130_fd_sc_hd__clkbuf_2 rebuffer10 (.A(_229_),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_16 clone11 (.A(net5),
    .X(net39));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer8 (.A(_131_),
    .X(net40));
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(_204_));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_5_145 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_8_9 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_10_126 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_11_135 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_12_66 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_12_183 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_21_7 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_23_182 ();
 sky130_fd_sc_hd__decap_8 FILLER_0_24_18 ();
 sky130_fd_sc_hd__fill_2 FILLER_0_24_26 ();
 sky130_fd_sc_hd__decap_6 FILLER_0_24_32 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_29_75 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_35_22 ();
 sky130_fd_sc_hd__fill_1 FILLER_0_35_30 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_37_71 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_37_121 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_41_9 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_42_180 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_43_30 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_43_145 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_45_38 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_45_155 ();
