module project2 (A,
 ...
 sky130_fd_sc_hd__buf_4 _234_ (.A(net9),
    .X(_165_));
 sky130_fd_sc_hd__clkbuf_4 _235_ (.A(_165_),
    .X(_166_));
 ...
 sky130_fd_sc_hd__or3b_1 _246_ (.A(net19),
    ...
    .C_N(net17),
    .X(_176_));
 sky130_fd_sc_hd__buf_2 _247_ (.A(_176_),
    .X(_177_));
 sky130_fd_sc_hd__buf_4 _248_ (.A(net10),
    .X(_178_));
 sky130_fd_sc_hd__a21oi_1 _249_ (.A1(_166_),
    .A2(_177_),
    .B1(_178_),
    .Y(_179_));
 sky130_fd_sc_hd__and3_1 _250_ (.A(_165_),
    .B(_178_),
    .C(_177_),
    .X(_180_));
 sky130_fd_sc_hd__clkbuf_4 _251_ (.A(net2),
    .X(_181_));
 sky130_fd_sc_hd__o21a_1 _252_ (.A1(_179_),
    .A2(_180_),
    .B1(_181_),
    .X(_182_));
 sky130_fd_sc_hd__nor3_2 _253_ (.A(_181_),
    .B(_179_),
    .C(_180_),
    .Y(_183_));
 ...
 sky130_fd_sc_hd__a31o_1 _270_ (.A1(_185_),
    ...
    .B1(_199_),
    .X(net21));
 sky130_fd_sc_hd__and4_2 _271_ (.A(net9),
    .B(net2),
    .C(net10),
    .D(net3),
    .X(_200_));
 ...
 sky130_fd_sc_hd__and4b_2 _274_ (.A_N(_200_),
    ...
    .D(_202_),
    .X(_203_));
 sky130_fd_sc_hd__clkbuf_8 _275_ (.A(net3),
    .X(_204_));
 ...
 sky130_fd_sc_hd__o21ai_1 _280_ (.A1(_195_),
    ...
    .B1(_196_),
    .Y(_209_));
 sky130_fd_sc_hd__o21a_2 _281_ (.A1(_165_),
    .A2(_178_),
    .B1(_177_),
    .X(_210_));
 ...
 sky130_fd_sc_hd__xor2_2 _283_ (.A(_204_),
    .B(_211_),
    .X(_212_));
 sky130_fd_sc_hd__o21bai_2 _284_ (.A1(_183_),
    .A2(_184_),
    .B1_N(_182_),
    .Y(_213_));
 sky130_fd_sc_hd__and2_1 _285_ (.A(_212_),
    .B(_213_),
    .X(_214_));
 ...
 sky130_fd_sc_hd__nand2_2 _294_ (.A(net2),
    .B(_201_),
    .Y(_222_));
 sky130_fd_sc_hd__and4_1 _295_ (.A(net9),
    .B(net10),
    .C(net3),
    .D(net4),
    .X(_223_));
 sky130_fd_sc_hd__buf_4 _296_ (.A(net4),
    .X(_224_));
 sky130_fd_sc_hd__a22oi_4 _297_ (.A1(_178_),
    .A2(_204_),
    .B1(_224_),
    .B2(_165_),
    .Y(_225_));
 sky130_fd_sc_hd__nor2_2 _298_ (.A(_223_),
    .B(_225_),
    .Y(_226_));
 sky130_fd_sc_hd__xnor2_2 _299_ (.A(_222_),
    .B(_226_),
    .Y(_227_));
 sky130_fd_sc_hd__nor2_2 _300_ (.A(_200_),
    .B(_203_),
    .Y(_228_));
 sky130_fd_sc_hd__xnor2_2 _301_ (.A(_227_),
    .B(_228_),
    .Y(_229_));
 sky130_fd_sc_hd__and3_2 _302_ (.A(_167_),
    .B(_221_),
    .C(_229_),
    .X(_230_));
 ...
 sky130_fd_sc_hd__and2_1 _307_ (.A(_204_),
    .B(_211_),
    .X(_001_));
 sky130_fd_sc_hd__o31a_1 _308_ (.A1(_165_),
    .A2(_178_),
    .A3(_201_),
    .B1(_177_),
    .X(_002_));
 ...
 sky130_fd_sc_hd__nor3_1 _312_ (.A(_224_),
    ...
    .C(_004_),
    .Y(_006_));
 sky130_fd_sc_hd__nor2_1 _313_ (.A(_005_),
    .B(_006_),
    .Y(_007_));
 ...
 sky130_fd_sc_hd__a31o_1 _321_ (.A1(_196_),
    ...
    .B1(_014_),
    .X(net23));
 sky130_fd_sc_hd__buf_4 _322_ (.A(net5),
    .X(_015_));
 sky130_fd_sc_hd__buf_4 _323_ (.A(net13),
    .X(_016_));
 sky130_fd_sc_hd__o21a_1 _324_ (.A1(_221_),
    .A2(_002_),
    .B1(_177_),
    .X(_017_));
 sky130_fd_sc_hd__xnor2_2 _325_ (.A(_016_),
    .B(_017_),
    .Y(_018_));
 sky130_fd_sc_hd__nand2_2 _326_ (.A(_015_),
    .B(_018_),
    .Y(_019_));
 sky130_fd_sc_hd__or2_1 _327_ (.A(_015_),
    .B(_018_),
    .X(_020_));
 sky130_fd_sc_hd__and2_1 _328_ (.A(_019_),
    .B(_020_),
    .X(_021_));
 sky130_fd_sc_hd__or3_1 _329_ (.A(_005_),
    ...
    .C(_021_),
    .X(_022_));
 sky130_fd_sc_hd__o21ai_2 _330_ (.A1(_005_),
    .A2(_008_),
    .B1(_021_),
    .Y(_023_));
 sky130_fd_sc_hd__and2b_1 _331_ (.A_N(_228_),
    .B(_227_),
    .X(_024_));
 sky130_fd_sc_hd__and4_2 _332_ (.A(net1),
    .B(_181_),
    .C(net12),
    .D(_016_),
    .X(_025_));
 sky130_fd_sc_hd__a22oi_1 _333_ (.A1(_181_),
    ...
    .B2(net1),
    .Y(_026_));
 sky130_fd_sc_hd__or2_2 _334_ (.A(_025_),
    .B(_026_),
    .X(_027_));
 sky130_fd_sc_hd__nand4_4 _335_ (.A(_165_),
    .B(net10),
    .C(net4),
    .D(_015_),
    .Y(_028_));
 sky130_fd_sc_hd__a22o_2 _336_ (.A1(net10),
    .A2(net4),
    .B1(net5),
    .B2(_165_),
    .X(_029_));
 ...
 sky130_fd_sc_hd__nand3_1 _338_ (.A(_216_),
    ...
    .C(_029_),
    .Y(_031_));
 sky130_fd_sc_hd__o21bai_2 _339_ (.A1(_222_),
    .A2(_225_),
    .B1_N(_223_),
    .Y(_032_));
 sky130_fd_sc_hd__and3_1 _340_ (.A(_030_),
    .B(_031_),
    .C(_032_),
    .X(_033_));
 ...
 sky130_fd_sc_hd__xnor2_2 _343_ (.A(_027_),
    .B(_035_),
    .Y(_036_));
 sky130_fd_sc_hd__o21a_2 _344_ (.A1(_024_),
    .A2(_230_),
    .B1(_036_),
    .X(_037_));
 ...
 sky130_fd_sc_hd__xnor2_1 _347_ (.A(_000_),
    .B(_039_),
    .Y(_040_));
 sky130_fd_sc_hd__nor2_1 _348_ (.A(_015_),
    .B(_173_),
    .Y(_041_));
 sky130_fd_sc_hd__a31o_1 _349_ (.A1(_015_),
    .A2(_016_),
    .A3(net28),
    .B1(_041_),
    .X(_042_));
 sky130_fd_sc_hd__a21oi_1 _350_ (.A1(_015_),
    .A2(_016_),
    .B1(_190_),
    .Y(_043_));
 sky130_fd_sc_hd__o22a_1 _351_ (.A1(_015_),
    .A2(_016_),
    .B1(_169_),
    .B2(_043_),
    .X(_044_));
 ...
 sky130_fd_sc_hd__a31o_1 _353_ (.A1(_186_),
    ...
    .B1(_045_),
    .X(net24));
 sky130_fd_sc_hd__buf_4 _354_ (.A(net6),
    .X(_046_));
 ...
 sky130_fd_sc_hd__a22oi_2 _357_ (.A1(_204_),
    ...
    .B2(net2),
    .Y(_049_));
 sky130_fd_sc_hd__nor2_2 _358_ (.A(_048_),
    .B(_049_),
    .Y(_050_));
 sky130_fd_sc_hd__xnor2_4 _359_ (.A(_047_),
    .B(_050_),
    .Y(_051_));
 sky130_fd_sc_hd__nand4_2 _360_ (.A(_165_),
    .B(net10),
    .C(net5),
    .D(_046_),
    .Y(_052_));
 sky130_fd_sc_hd__a22o_2 _361_ (.A1(net10),
    .A2(net5),
    .B1(net6),
    .B2(net9),
    .X(_053_));
 sky130_fd_sc_hd__and2_1 _362_ (.A(net11),
    .B(net4),
    .X(_054_));
 sky130_fd_sc_hd__a21o_1 _363_ (.A1(_052_),
    .A2(_053_),
    .B1(_054_),
    .X(_055_));
 sky130_fd_sc_hd__nand3_2 _364_ (.A(_054_),
    ...
    .C(_053_),
    .Y(_056_));
 sky130_fd_sc_hd__a21bo_1 _365_ (.A1(_216_),
    .A2(_029_),
    .B1_N(_028_),
    .X(_057_));
 sky130_fd_sc_hd__nand3_2 _366_ (.A(_055_),
    .B(_056_),
    .C(_057_),
    .Y(_058_));
 sky130_fd_sc_hd__a21o_2 _367_ (.A1(_055_),
    .A2(_056_),
    .B1(_057_),
    .X(_059_));
 sky130_fd_sc_hd__nand3_2 _368_ (.A(_051_),
    ...
    .C(_059_),
    .Y(_060_));
 sky130_fd_sc_hd__a21o_1 _369_ (.A1(_058_),
    .A2(_059_),
    .B1(_051_),
    .X(_061_));
 sky130_fd_sc_hd__o21bai_2 _370_ (.A1(_027_),
    .A2(_034_),
    .B1_N(_033_),
    .Y(_062_));
 sky130_fd_sc_hd__nand3_4 _371_ (.A(_060_),
    .B(_061_),
    .C(_062_),
    .Y(_063_));
 sky130_fd_sc_hd__a21o_1 _372_ (.A1(_060_),
    .A2(_061_),
    .B1(_062_),
    .X(_064_));
 sky130_fd_sc_hd__a21o_1 _373_ (.A1(_063_),
    .A2(_064_),
    .B1(_025_),
    .X(_065_));
 sky130_fd_sc_hd__nand3_4 _374_ (.A(_025_),
    .B(_063_),
    .C(_064_),
    .Y(_066_));
 sky130_fd_sc_hd__nand3_4 _375_ (.A(_037_),
    ...
    .C(_066_),
    .Y(_067_));
 sky130_fd_sc_hd__a21o_1 _376_ (.A1(_065_),
    .A2(_066_),
    .B1(_037_),
    .X(_068_));
 ...
 sky130_fd_sc_hd__nand2_1 _380_ (.A(_019_),
    .B(_023_),
    .Y(_072_));
 sky130_fd_sc_hd__o21a_1 _381_ (.A1(_016_),
    .A2(_017_),
    .B1(_177_),
    .X(_073_));
 sky130_fd_sc_hd__xnor2_2 _382_ (.A(net14),
    .B(_073_),
    .Y(_074_));
 sky130_fd_sc_hd__nand2_2 _383_ (.A(_046_),
    .B(_074_),
    .Y(_075_));
 sky130_fd_sc_hd__or2_1 _384_ (.A(_046_),
    .B(_074_),
    .X(_076_));
 sky130_fd_sc_hd__and2_1 _385_ (.A(_075_),
    .B(_076_),
    .X(_077_));
 sky130_fd_sc_hd__xor2_1 _386_ (.A(_072_),
    .B(_077_),
    .X(_078_));
 sky130_fd_sc_hd__a21oi_2 _387_ (.A1(_046_),
    .A2(net14),
    .B1(_190_),
    .Y(_079_));
 sky130_fd_sc_hd__o22a_1 _388_ (.A1(_046_),
    .A2(net14),
    .B1(_169_),
    .B2(_079_),
    .X(_080_));
 sky130_fd_sc_hd__a31o_1 _389_ (.A1(_046_),
    .A2(net14),
    .A3(net28),
    .B1(_080_),
    .X(_081_));
 sky130_fd_sc_hd__a21oi_1 _390_ (.A1(_186_),
    ...
    .B1(_081_),
    .Y(_082_));
 sky130_fd_sc_hd__o211ai_2 _391_ (.A1(_046_),
    .A2(_173_),
    .B1(_071_),
    .C1(_082_),
    .Y(net25));
 sky130_fd_sc_hd__a21bo_1 _392_ (.A1(_019_),
    .A2(_023_),
    .B1_N(_077_),
    .X(_083_));
 sky130_fd_sc_hd__or2_1 _393_ (.A(net14),
    .B(_073_),
    .X(_084_));
 sky130_fd_sc_hd__nand2_2 _394_ (.A(_177_),
    .B(_084_),
    .Y(_085_));
 sky130_fd_sc_hd__xor2_4 _395_ (.A(net15),
    .B(_085_),
    .X(_086_));
 sky130_fd_sc_hd__xnor2_2 _396_ (.A(net7),
    .B(_086_),
    .Y(_087_));
 sky130_fd_sc_hd__a21oi_2 _397_ (.A1(_075_),
    .A2(_083_),
    .B1(_087_),
    .Y(_088_));
 ...
 sky130_fd_sc_hd__xnor2_2 _401_ (.A(_090_),
    .B(_091_),
    .Y(_092_));
 sky130_fd_sc_hd__nand4_4 _402_ (.A(_165_),
    .B(net10),
    .C(_046_),
    .D(net7),
    .Y(_093_));
 sky130_fd_sc_hd__a22o_2 _403_ (.A1(net10),
    ...
    .B2(net9),
    .X(_094_));
 sky130_fd_sc_hd__a22o_2 _404_ (.A1(_201_),
    .A2(_015_),
    .B1(_093_),
    .B2(_094_),
    .X(_095_));
 sky130_fd_sc_hd__nand4_4 _405_ (.A(_201_),
    ...
    .D(_094_),
    .Y(_096_));
 sky130_fd_sc_hd__a21bo_1 _406_ (.A1(_054_),
    .A2(_053_),
    .B1_N(_052_),
    .X(_097_));
 ...
 sky130_fd_sc_hd__and4_1 _411_ (.A(_204_),
    ...
    .D(net13),
    .X(_102_));
 sky130_fd_sc_hd__nor2_1 _412_ (.A(_101_),
    .B(_102_),
    .Y(_103_));
 sky130_fd_sc_hd__xnor2_1 _413_ (.A(_100_),
    .B(_103_),
    .Y(_104_));
 ...
 sky130_fd_sc_hd__nand3_2 _415_ (.A(_104_),
    ...
    .C(_099_),
    .Y(_106_));
 sky130_fd_sc_hd__a21bo_1 _416_ (.A1(_051_),
    .A2(_059_),
    .B1_N(_058_),
    .X(_107_));
 ...
 sky130_fd_sc_hd__a21o_1 _418_ (.A1(_105_),
    ...
    .B1(_107_),
    .X(_109_));
 sky130_fd_sc_hd__and3_1 _419_ (.A(_092_),
    .B(_108_),
    .C(_109_),
    .X(_110_));
 sky130_fd_sc_hd__a21oi_2 _420_ (.A1(_108_),
    ...
    .B1(_092_),
    .Y(_111_));
 sky130_fd_sc_hd__a211o_2 _421_ (.A1(_063_),
    .A2(_066_),
    .B1(_110_),
    .C1(_111_),
    .X(_112_));
 ...
 sky130_fd_sc_hd__and3b_1 _423_ (.A_N(_067_),
    ...
    .C(_113_),
    .X(_114_));
 sky130_fd_sc_hd__a21bo_1 _424_ (.A1(_112_),
    .A2(_113_),
    .B1_N(_067_),
    .X(_115_));
 sky130_fd_sc_hd__and2b_1 _425_ (.A_N(_114_),
    .B(_115_),
    .X(_116_));
 sky130_fd_sc_hd__nand2_1 _426_ (.A(_070_),
    .B(_116_),
    .Y(_117_));
 sky130_fd_sc_hd__o21a_1 _427_ (.A1(_070_),
    .A2(_116_),
    .B1(_196_),
    .X(_118_));
 ...
 sky130_fd_sc_hd__a311o_1 _431_ (.A1(net7),
    ...
    .C1(_121_),
    .X(_122_));
 sky130_fd_sc_hd__a21oi_1 _432_ (.A1(_117_),
    .A2(_118_),
    .B1(_122_),
    .Y(_123_));
 ...
 sky130_fd_sc_hd__xnor2_2 _439_ (.A(_127_),
    .B(_128_),
    .Y(_129_));
 sky130_fd_sc_hd__xnor2_1 _440_ (.A(_124_),
    .B(_129_),
    .Y(_130_));
 ...
 sky130_fd_sc_hd__or2b_1 _453_ (.A(_141_),
    .B_N(_142_),
    .X(_143_));
 sky130_fd_sc_hd__nand2_1 _454_ (.A(_093_),
    .B(_096_),
    .Y(_144_));
 ...
 sky130_fd_sc_hd__nand2_1 _469_ (.A(_131_),
    .B(_158_),
    .Y(_159_));
 sky130_fd_sc_hd__o21a_1 _470_ (.A1(_131_),
    .A2(_158_),
    .B1(_196_),
    .X(_160_));
 ...
 sky130_fd_sc_hd__clkbuf_2 input16 (.A(B[7]),
    .X(net16));
 sky130_fd_sc_hd__clkbuf_4 input17 (.A(opcode[0]),
    .X(net17));
